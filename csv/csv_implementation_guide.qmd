...
**enrollment.external_policy_id**: The unique ID for the policy assigned by the platform. It's suggested that platforms should assign a new external_policy_id if the plan changes or plan year changes.
